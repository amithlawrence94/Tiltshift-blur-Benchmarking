...
import static edu.asu.ame.meteor.speedytiltshift2018.SpeedyTiltShift.javaElapsedTime;
    ...
    private void setupUI(){
        ...
        javabtn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                myTextView.setText("Using Java: Elapsed time:"+javaElapsedTime+" ms");
            }
        });
        cppbtn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                cppPress(view);
                TextView myTextView = (TextView)findViewById(R.id.textBox);
                myTextView.setText("Using C++: Elapsed time:"+javaElapsedTime+" ms");
            }
        });
        neonbtn.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View view) {
                neonPress(view);
                TextView myTextView = (TextView)findViewById(R.id.textBox);
                myTextView.setText("Using Neon: Elapsed time:"+javaElapsedTime+" ms");
            }
        });
